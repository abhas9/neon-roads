...
export function titleScreen(save: SaveData, dailyLabel: string, phoneLabel: string, wandLabel: string, handLabel: string): string {
  ...
  <div class="screen title-screen">
    ...
    <nav class="menu">
      ...
      <button class="nav btn" data-action="wand">Wand Controller <small class="wand-status">${wandLabel}</small></button>
